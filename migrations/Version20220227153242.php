 ...
 */
final class Version20220227153242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, leproduit_id INT DEFAULT NULL, letypeenchere_id INT DEFAULT NULL, datedebut DATETIME NOT NULL, datefin DATETIME NOT NULL, prixreserve DOUBLE PRECISION NOT NULL, INDEX IDX_38D1870F9BB0CB11 (leproduit_id), INDEX IDX_38D1870FC38B1943 (letypeenchere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
