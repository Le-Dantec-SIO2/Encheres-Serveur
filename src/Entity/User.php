...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Encherir::class, mappedBy="leuser")
     */
    ...
    public function removeLesencherir(Encherir $lesencherir): self
    {
        if ($this->lesencherirs->removeElement($lesencherir)) {
            ...
            if ($lesencherir->getLeuser() === $this) {
                $lesencherir->setLeuser(null);
            }
        }
    ...
    {
    return is_resource($this->photo) ? stream_get_contents($this->photo) : $this->photo;
