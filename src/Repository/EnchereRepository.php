...
class EnchereRepository extends ServiceEntityRepository
{
    ...
    public function findEncheres($enchereId = false)
    {
        ...
        if($enchereId){
            return $this->createQueryBuilder('e')
                ...
                p.prixreel, p.nom, p.photo, p.prixreel")            
                ->getQuery()
                ->getResult()
            ;
        }else{
    ...
    public function findEncheresParticipes(User $user){
        return $this->createQueryBuilder('e')
            ...
            ->select("e.id,DATE_FORMAT(e.datedebut,'%Y-%m-%d') AS date_debut,DATE_FORMAT(e.datefin,'%Y-%m-%d') AS date_fin,p.nom,p.photo,p.prixreel")
            ->getQuery()
            ->getResult();
